<?php
    ...
    $post_label=$post -> post_content_filtered;
	...
	<form method="post" action="<?php _e(  $insert_path, 'excellence-fee' ); ?>" name="fee_form" class="fee_form">
		<div class="input-form">
			...
			<div class="input_fee">
				...
				<input type="text" name="excel_fee" class="excel_fee" placeholder="<?php _e( 'enter excellence fee', 'excellence-fee' );	?>" value="<?php _e( $postval ); ?>">

			</div>
			<div class="input_fee_label">
				<div class="form_label">
					<label><?php _e( 'Enter Fee Label: ', 'excellence-fee' ); ?>
					</label>
				</div>
				<input type="text" name="excel_label" class="excel_label" placeholder="<?php _e( 'Excellence Fee', 'excellence-fee' );	?>" value="<?php _e($post_label); ?>">
